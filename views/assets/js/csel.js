...
(() => {
  ...
  if (document.getElementById('csel')) {
    ...
    */
    ...
    attachClassEventListener('usepublicwisp', 'change', (e) => {
      if (checkBooleanState(e.target) === true) setStorage('PublicWisp', true);
      else removeStorage('PublicWisp');
    });
  ...
  */
  ...
  useStorageArgs('PublicWisp', (s) => {
    if (s !== false)
      classUpdateHandler(document.getElementsByClassName('usepublicwisp'), 'on')();
  });
})();
